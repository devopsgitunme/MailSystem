<%@ Page Title="" Language="C#" MasterPageFile="~/Mail/MailMaster.master" AutoEventWireup="true" CodeFile="Trash.aspx.cs" Inherits="Mail_Trash" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <div id="InboxContent">
        <asp:GridView ID="GvSentItems" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="MailId" Visible="False">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("MailId") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="SentId" HeaderText="From">
                <ItemStyle Width="18%" />
                </asp:BoundField>
